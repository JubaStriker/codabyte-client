    ...
    return (
        <div>
            ...
            <footer className="p-4 bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 rounded-b-lg shadow md:px-6 md:py-8">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-900">© 2022 <a href="https://flowbite.com/" className="hover:underline">CodaByte™</a>. All Rights Reserved.
                </span>
            </footer>
